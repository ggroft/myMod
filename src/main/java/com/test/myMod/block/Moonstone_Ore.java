...
public class Moonstone_Ore extends Block {
    ...
    public Moonstone_Ore(String unlocalizedName, Material mat, Item drop, int meta, int least_quantity, int most_quantity) {
        super(mat);
        this.drop = drop;
        this.meta = meta;
        ...
        this.setBlockName(Names.Blocks.MOONSTONE_ORE);
        this.setCreativeTab(CreativeTabmyMod.myMod_TAB);
    }
    public Moonstone_Ore(String unlocalizedName, Material mat, Item drop, int least_quantity, int most_quantity) {
        this(unlocalizedName, mat, drop, 0, least_quantity, most_quantity);
    }
    public Moonstone_Ore(String unlocalizedName, Material mat, Item drop) {
