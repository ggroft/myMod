...
public class Citrine_Ore extends Block {
    private Item drop;
    private int meta;
    ...
    public Citrine_Ore(String unlocalizedName, Material mat, Item drop, int meta, int least_quantity, int most_quantity) {
        super(mat);
        this.drop = drop;
        this.meta = meta;
        ...
        this.setBlockName(Names.Blocks.CITRINE_ORE);
        this.setCreativeTab(CreativeTabmyMod.myMod_TAB);
    }
    public Citrine_Ore(String unlocalizedName, Material mat, Item drop, int least_quantity, int most_quantity) {
        this(unlocalizedName, mat, drop, 0, least_quantity, most_quantity);
    }
    public Citrine_Ore(String unlocalizedName, Material mat, Item drop) {
