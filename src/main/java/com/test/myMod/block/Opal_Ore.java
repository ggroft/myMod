...
public class Opal_Ore extends Block {
    private Item drop;
    private int meta;
    ...
    public Opal_Ore(String unlocalizedName, Material mat, Item drop, int meta, int least_quantity, int most_quantity) {
        super(mat);
        this.drop = drop;
        this.meta = meta;
        ...
        this.setBlockName(Names.Blocks.OPAL_ORE);
        this.setCreativeTab(CreativeTabmyMod.myMod_TAB);
    }
    public Opal_Ore(String unlocalizedName, Material mat, Item drop, int least_quantity, int most_quantity) {
        this(unlocalizedName, mat, drop, 0, least_quantity, most_quantity);
    }
    public Opal_Ore(String unlocalizedName, Material mat, Item drop) {
